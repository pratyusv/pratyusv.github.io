...
A human-readable interpretation looks like this:

| Slot range | Master | Replica |
|---|---|---|
| `0-5460` | `10.0.1.10:6379` (`node-id-m1`) | `10.0.2.11:6379` (`node-id-r1`) |
| `5461-10922` | `10.0.2.10:6379` (`node-id-m2`) | `10.0.3.11:6379` (`node-id-r2`) |
| `10923-16383` | `10.0.3.10:6379` (`node-id-m3`) | `10.0.1.11:6379` (`node-id-r3`) |

The actual Redis CLI output is nested RESP data. One slot-range entry looks like this:
...
This entry means: slots `0-5460` are served by master `10.0.1.10:6379`, with replica `10.0.2.11:6379`.
...
![Redis Object](/assets/img/redis/redis_object.png)
...
![Redis Object](/assets/img/redis/write_replicas.png)
